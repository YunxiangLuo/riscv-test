    ...
    with open("logs/"+log , "r") as f:
        ...
        for line in f.readlines():
            ...
            if conut == 2:
                ...
                sheet[pq][datalist[1]] = sheet[pq].get(datalist[1] , {})
                sheet[pq][datalist[1]][datalist[2]] = sheet[pq][datalist[1]].get(datalist[2] , [0.0 , 0])
                sheet[pq][datalist[1]][datalist[2]][0] += float(datalist[6])
                sheet[pq][datalist[1]][datalist[2]][1] += 1
            conut += 1
        for pq , sheet1 in sheet.items():
            for (key , val) in sheet1.items():
                ...
                for nb , Gf in val.items():
                    ...
                    i += 1
                workbook.save("NB-Gf/ana"+"p,q="+pq[0]+","+pq[2]+" "+"N="+key+".xls")